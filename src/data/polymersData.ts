...
export const polymersData: PolymerData[] = [
  ...
  // ---------------------------------------------------------
  {
    ...
    chemicalResistance: [
      ...
      {
        category: 'ترک‌خوردگی تنشی محیطی (ESCR)',
        rating: 'خوب',
        colorClass: 'text-accent-secondary',
      },
      {
        category: 'هیدروکربن‌های آلیفاتیک',
        rating: 'خوب (تورم جزئی)',
      ...
      {
        category: 'اشعه فرابنفش (UV)',
        rating: 'ضعیف (نیاز به پایدارکننده)',
    ...
    academic: {
      ...
      reactorTypes: [
        'راکتور لوله‌ای (Tubular) - PDI باریک‌تر',
        'راکتور اتوکلاو (Autoclave) - LCB بیشتر',
      ],
      kineticNotes:
    ...
    quiz: [
      ...
      },
      {
        ...
        opts: [
          'بلورینگی بالا',
          'وزن مولکولی عددی بسیار بالا',
          'حضور شاخه‌های بلند (Long Chain Branching)',
          'ساختار ارتورومبیک',
        ],
        correct: 2,
  ...
  // ---------------------------------------------------------
  {
    ...
    chemicalResistance: [
      {
        category: 'اسیدها، بازها و نمک‌ها',
        rating: 'بسیار عالی',
    ...
    academic: {
      ...
      reactorTypes: [
        'راکتور دوغابی (Slurry) - Mw بالا',
        'راکتور فاز گازی (Gas Phase) - تنوع گرید',
        'راکتور محلول (Solution)',
      ],
      kineticNotes:
    ...
    quiz: [
      ...
      },
      {
        ...
        opts: [
          'دارای شاخه‌های بلند و کوتاه فراوان',
          'خطی و با تراکم شاخه بسیار کم',
          'کاملاً شبکه‌ای (Cross-linked)',
          'شاخه‌دار بودن منظم',
        ],
        correct: 1,
      ...
      },
      {
        ...
        opts: [
          'افزایش شدید شاخص چندپخشی (PDI)',
          'تولید پلیمر با PDI باریک (نزدیک به 2)',
          'کاهش شدید وزن مولکولی',
          'تولید شاخه‌های بلند',
        ],
        correct: 1,
  ...
  // ---------------------------------------------------------
  {
    ...
    mechanical: {
      ...
      description:
        'PP در دمای محیط دارای مدول و استحکام عالی است اما در دماهای زیر صفر درجه (نزدیک Tg) ترد می‌شود، لذا از کوپلیمرهای اتان-پروپیلن برای کاربردهای برودتی استفاده می‌شود.',
    },
    physical: {
    ...
    chemicalResistance: [
      ...
      {
        category: 'اشعه فرابنفش (UV)',
        rating: 'ضعیف (نیاز به UV stabilizer)',
        colorClass: 'text-status-error',
      },
    ],
    electrical: {
    ...
    academic: {
      ...
      mechanism:
        'کاتالیزور زیگلر-ناتا پایه تیتانیوم (Stereospecific) یا کاتالیزور متالوسن جهت کنترل تتاکتیسیته (Isotactic PP)',
      reactorTypes: ['راکتور فاز گازی (Gas Phase Loop)', 'راکتور دوغابی (Bulk Liquid Monomer)'],
      kineticNotes:
        'کنترل تاکتیسیته (ایزوتاکتیک، سیندیوتاکتیک، آتاکتیک) تعیین‌کننده درجه بلورینگی و خواص مکانیکی است.',
    ...
    quiz: [
      ...
      },
      {
        ...
        opts: [
          'به دلیل چگالی بالا',
          'به دلیل مقاومت عالی در برابر خستگی ناشی از خم شدن مکرر',
          'به دلیل شفافیت مطلق',
          'به دلیل دمای ذوب پایین',
        ],
        correct: 1,
  ...
  // ---------------------------------------------------------
  {
    ...
    processing: {
      ...
      mfi: {
        value: 'ارزیابی با K-Value',
        note: 'مثلاً K-67 یا K-57',
        unit: '',
    ...
    mechanical: {
      ...
      description:
        'خواص مکانیکی PVC وابسته به میزان نرم‌کننده است؛ U-PVC مدول کششی بالایی (2.5-4.0 GPa) دارد، در حالی که PVC نرم، انعطاف‌پذیری و تغییر شکل تسلیم بالایی از خود نشان می‌دهد.',
    },
    physical: {
    ...
    chemicalResistance: [
      ...
      {
        category: 'کتون‌ها و استرها (MEK, THF)',
        rating: 'حلال و ضعیف',
        colorClass: 'text-status-error',
      },
    ...
    academic: {
      ...
      monomerMolarMass: 62.5,
      repeatingUnit: '[CH2 - CH(Cl)]n',
      crystallinityRange: {
        value: '5 - 10',
        note: 'غالباً آمورف / بی‌شکل',
        unit: '%',
        sourceId: 'src_default',
      },
      minCrystallinity: 5,
      ...
      rheologyNotes:
        'ذرات PVC در مذاب ساختار گرانولی خود را حفظ می‌کنند و فرآیند پخت (Fusion) رخ می‌دهد.',
      ...
      thermoNotes:
        'گروه قطبی C-Cl گشتاور دو قطبی ایجاد کرده و Tg را به بالای 80 درجه سانتی‌گراد می‌رساند.',
    },
    chainType: 'polar_cl',
    quiz: [
      {
  ...
  // ---------------------------------------------------------
  {
    ...
    processing: {
      ...
      mfi: {
        value: 'ارزیابی با ویسکوزیته ذاتی IV',
        note: 'مثلاً 0.80 dL/g برای بطری',
        unit: '',
        sourceId: 'src_default',
      },
      bur: {
        value: 'فرآیند کشش دو محوره',
    ...
    mechanical: {
      tensileStrength: {
        value: '50 - 80 (Unoriented) / 150 - 250 MPa',
        note: 'Oriented Film/Fiber',
        unit: 'MPa',
        sourceId: 'src_default',
      },
      ...
      description:
        'کشش دو محوره (Biaxial Orientation) جهت‌گیری زنجیرها و بلورینگی ناشی از کرنش ایجاد کرده و استحکام کششی را تا 250 MPa می‌رساند.',
    },
    physical: {
      density: {
        value: '1.38 - 1.40',
        note: 'Amorphous: 1.33 g/cm³',
        unit: 'g/cm³',
        sourceId: 'src_default',
      },
      minDensity: 1.33,
    ...
    chemicalResistance: [
      ...
      {
        category: 'روغن‌ها و حلال‌های آلیفاتیک',
        rating: 'عالی',
        colorClass: 'text-status-success',
      },
      {
        category: 'بازهای قوی و آمین‌ها',
        rating: 'ضعیف (تخریب استری)',
        colorClass: 'text-status-error',
      },
    ...
    academic: {
      ...
      mechanism:
        'پلیمریزاسیون تراکمی (Polycondensation) فاز مذاب و سپس ارتقاء وزن مولکولی در فاز جامد (SSP)',
      reactorTypes: [
        'راکتور Esterification',
        'راکتور Polycondensation',
        'برج SSP (Solid State Polymerization)',
      ],
      ...
      rheologyNotes:
        'مذاب PET رفتار نیوتنی‌تر دارد و ویسکوزیته آن وابستگی شدیدی به دمای مذاب دارد.',
  ...
  // ---------------------------------------------------------
  {
    ...
    mechanical: {
      ...
      izodImpact: {
        value: '15 - 25 (GPPS) / 70 - 120 J/m',
        note: 'HIPS',
        unit: 'J/m',
        sourceId: 'src_default',
      },
      description:
        'GPPS بسیار سخت اما ترد و شکننده است، در حالی که HIPS با افزودن ذرات لاستیک PB چقرمه شده است.',
    },
    physical: {
    ...
    chemicalResistance: [
      ...
      { category: 'الکل‌ها', rating: 'خیلی خوب', colorClass: 'text-status-success' },
      {
        category: 'حلال‌های آلیفاتیک و استون',
        rating: 'حل‌شونده و ضعیف',
        colorClass: 'text-status-error',
      },
      {
    ...
    quiz: [
      {
        ...
        opts: [
          'چگالی بالا',
          'وجود حلقه فنیل حجیم و ساختار آتاکتیک آمورف',
          'کشش دو محوره',
          'درصد بلورینگی 90%',
        ],
        correct: 1,
