          ...
          <table className="w-full text-sm border-collapse">
            <thead>
              <tr className="bg-bg-surface text-text-secondary">
                ...
                <th className="p-3.5 text-center text-accent-primary font-extrabold en-mono font-mono tabular-nums">
                  {p1.code}
                </th>
                <th className="p-3.5 text-center text-accent-primary font-extrabold en-mono font-mono tabular-nums">
                  {p2.code}
            ...
            <tbody className="divide-y divide-slate-200 divide-slate-800 bg-bg-surface/60 text-text-primary">
              ...
              <tr>
                ...
                <td className="p-3.5 text-center en-mono font-bold text-status-warning font-mono tabular-nums">
                  Resin #{p1.resinCode}
                </td>
                <td className="p-3.5 text-center en-mono font-bold text-status-warning font-mono tabular-nums">
                  Resin #{p2.resinCode}
              ...
              <tr>
                ...
                <td className="p-3.5 text-center en-mono font-mono tabular-nums">
                  {formatVal(p1.physical.density)}
                </td>
                <td className="p-3.5 text-center en-mono font-mono tabular-nums">
                  {formatVal(p2.physical.density)}
                </td>
              </tr>
              <tr>
                <td className="p-3.5 font-medium">دمای انتقال شیشه‌ای (Tg)</td>
                <td className="p-3.5 text-center en-mono font-mono tabular-nums">
                  {formatVal(p1.thermal.tg)}
                </td>
                <td className="p-3.5 text-center en-mono font-mono tabular-nums">
                  {formatVal(p2.thermal.tg)}
                </td>
              </tr>
              <tr>
                <td className="p-3.5 font-medium">دمای ذوب (Tm)</td>
                <td className="p-3.5 text-center en-mono font-mono tabular-nums">
                  {formatVal(p1.thermal.tm)}
                </td>
                <td className="p-3.5 text-center en-mono font-mono tabular-nums">
                  {formatVal(p2.thermal.tm)}
                </td>
              </tr>
              <tr>
                <td className="p-3.5 font-medium">استحکام کششی (Tensile Strength)</td>
                <td className="p-3.5 text-center en-mono font-mono tabular-nums">
                  {formatVal(p1.mechanical.tensileStrength)}
                </td>
                <td className="p-3.5 text-center en-mono font-mono tabular-nums">
                  {formatVal(p2.mechanical.tensileStrength)}
                </td>
              </tr>
              <tr>
                <td className="p-3.5 font-medium">مدول یانگ (Young Modulus)</td>
                <td className="p-3.5 text-center en-mono font-mono tabular-nums">
                  {formatVal(p1.mechanical.youngModulus)}
                </td>
                <td className="p-3.5 text-center en-mono font-mono tabular-nums">
                  {formatVal(p2.mechanical.youngModulus)}
                </td>
              </tr>
              <tr>
                <td className="p-3.5 font-medium">درصد بلورینگی (Crystallinity)</td>
                <td className="p-3.5 text-center en-mono font-mono tabular-nums">
                  {formatVal(p1.academic.crystallinityRange)}
                </td>
                <td className="p-3.5 text-center en-mono font-mono tabular-nums">
                  {formatVal(p2.academic.crystallinityRange)}
                </td>
              </tr>
              <tr>
                <td className="p-3.5 font-medium">دمای فرآیند شکل‌دهی</td>
                <td className="p-3.5 text-center en-mono font-mono tabular-nums">
                  {formatVal(p1.processing.processTemp)}
                </td>
                <td className="p-3.5 text-center en-mono font-mono tabular-nums">
                  {formatVal(p2.processing.processTemp)}
                </td>
              </tr>
            </tbody>
          </table>
